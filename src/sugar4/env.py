...
# DEPRECATED
def is_emulator():
    logging.error("sugar4.env.is_emulator is deprecated")
    return False
...
def get_user_activities_path():
    return os.environ.get("SUGAR_ACTIVITIES_PATH", os.path.expanduser("~/Activities"))


def get_user_library_path():
    return os.environ.get("SUGAR_LIBRARY_PATH", os.path.expanduser("~/Library"))
